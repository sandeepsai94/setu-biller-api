...
import com.setu.biller.repository.UserRepository;
import com.setu.biller.service.GenericService;
...
public class GenericServiceImpl implements GenericService {
	...
	private static final String UPDATE_BILL_FETCH_SQL = "update customer set billFetchStatus = 'NO_OUTSTANDING' where billerBillId = ?;";
	...
	public CustomerDetails findByBillerBillId(String billerBillId) {
		...
		return jdbcTemplate.queryForObject("select * from student where billerBillId=?", new Object[] {
				billerBillId
	        },
	        new BeanPropertyRowMapper < CustomerDetails > (CustomerDetails.class));
	}
